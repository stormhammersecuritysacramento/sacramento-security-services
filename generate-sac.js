...
// Exact matches for your uploaded repository files
...
<body class="bg-zinc-950 text-zinc-100 min-h-screen flex items-center justify-center p-4 antialiased">
    <div class="max-w-lg w-full bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl p-6 md:p-8 space-y-6">
        ...
        <div class="relative h-48 w-full bg-zinc-800 rounded-xl overflow-hidden border border-zinc-700">
            <!-- Explicit absolute path configuration for GitHub Pages subfolders -->
            <img src="/sacramento-security-services/${selectedImage}" alt="Stormhammer Fleet Asset Presence" class="w-full h-full object-cover object-center">
...
console.log("Sacramento campaign compiled with explicit asset routing paths.");
